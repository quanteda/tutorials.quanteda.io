...
{{% notice note %}}
Examples in this tutorial are written for **quanteda** version 2.1.2.9000. Please check if you have the same version installed by a command `packageVersion("quanteda")`. 
{{% /notice %}}
