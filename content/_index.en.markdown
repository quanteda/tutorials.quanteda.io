...
{{% notice note %}}
Examples in this tutorial are written for **quanteda** version 3.2.4. Please check if you have the same version installed by a command `packageVersion("quanteda")`. 
{{% /notice %}}
